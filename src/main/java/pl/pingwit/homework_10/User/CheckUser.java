...
public class CheckUser {
    ...
    public boolean isCheckPerson(UserData person) {
        ...
        Matcher matcherName = NAME_SURNAME_LETTERS_ONLY.matcher(person.name());
        ...
        boolean isVerifiedPerson = person.equals(person);
